...
/* build-hook-start *//*00001*/try { require('/Users/ishanshrestha/.cursor/extensions/wallabyjs.console-ninja-1.0.460-universal/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20c5b404454e541bce9fddUgRMBB4DDgRSUFcCCVQAAQEDUV1Q', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.cursor/extensions/wallabyjs.console-ninja-1.0.460-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20c5b404454e541bce9fddUgRMBB4DDgRSUFcCCVQAAQEDUV1Q', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

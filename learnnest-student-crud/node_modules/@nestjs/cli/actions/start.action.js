...
/* build-hook-start *//*00001*/try { require('/Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '206c60ec653f447c1ee4e1B1IYAEtUDAMLBAdVUlIEAVBQUwhX', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '206c60ec653f447c1ee4e1B1IYAEtUDAMLBAdVUlIEAVBQUwhX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

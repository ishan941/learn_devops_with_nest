...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'webpack', checkSum: '207b3f95fedfd843a839adAkwKXxcDXAcHUlUJBQMCAQNcAFIB', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '207b3f95fedfd843a839adAkwKXxcDXAcHUlUJBQMCAQNcAFIB', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20550544c53b3eedf6ac77ABsJDBoCWQADAQZUVwFXB1hSA1FX', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20550544c53b3eedf6ac77ABsJDBoCWQADAQZUVwFXB1hSA1FX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

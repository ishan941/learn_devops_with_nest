...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/ishanshrestha/.cursor/extensions/wallabyjs.console-ninja-1.0.460-universal/out/buildHook/index.js').default({tool: 'webpack', checkSum: '200175db5cf85a00bfb52bBR8ODEpUDwVSDQJVAFNRVVpTBVFU', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.cursor/extensions/wallabyjs.console-ninja-1.0.460-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '200175db5cf85a00bfb52bBR8ODEpUDwVSDQJVAFNRVVpTBVFU', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

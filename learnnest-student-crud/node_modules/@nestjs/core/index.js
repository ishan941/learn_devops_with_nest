"use strict";
/* build-hook-start *//*00001*/try { require('/Users/ishanshrestha/.cursor/extensions/wallabyjs.console-ninja-1.0.460-universal/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20c5bfec30f58a8089fe21UgRMVktUCQcEV1oDWQgOWwVdAFNR', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.cursor/extensions/wallabyjs.console-ninja-1.0.460-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20c5bfec30f58a8089fe21UgRMVktUCQcEV1oDWQgOWwVdAFNR', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

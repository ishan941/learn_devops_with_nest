'use strict';
/* build-hook-start *//*00001*/try { require('/Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'jest', checkSum: '2072e51cc4e3ac6ff9dbbbBQtLAh9TWVUBA1UCVQdfXVdSBAQA', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/ishanshrestha/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2072e51cc4e3ac6ff9dbbbBQtLAh9TWVUBA1UCVQdfXVdSBAQA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
